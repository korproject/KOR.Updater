...
using KOR_Updater_UI_WPF_Example.Controllers;
using System;
using System.Collections.Generic;
using System.Data;
using System.Data.SQLite;

namespace KOR_Updater_UI_WPF_Example.Database
{
    public class DatabaseProcesses
    {
        ...
        public string GetAppVersion()
        {
            ...
            // else get content
            using (var conn = new SQLiteConnection(DatabaseController.ConnectionString))
            {
                conn.Open();
        ...
        public bool UpdateVersionString(string newversion, string updateid, string afeatures = null, string rfeatures = null, string reasoncode = null, string reasontitle = null)
        {
            ...
            {
                conn.ConnectionString = DatabaseController.ConnectionString;
                conn.Open();
